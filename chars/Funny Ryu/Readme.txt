...
- 3 modes: Ryu, Funny Ryu and Master Ryu
- Every Ryu/Funny Ryu move ever seen in video games (let me know if i missed any :P) and more
...
- Defence is even lower than Funny Ryu's
...
Palettes 7, 8, 10, 11, 12  -> Funny Ryu
...
.Classic Kuuchuu Tatsumaki:        F, DF, D, DB, B, k
.(N) Joudan Sokutou Geri:          D, DF, F, k (EX)
.(E) Ryusokyaku                    D, DF, F, k (EX)
.(E) Shakunetsu Hadou Ken:         F, DF, D, DB, B, p (EX)
.(E) Ashura Senkuu Zenpou:         F, D, DF, 3p/3k
.(E) Ashura Senkuu Kouhou:         B, D, DB, 3p/3k
...
.(E) Metsu Shoryuu ken:            D, DF, F, DF, D, DF, F, 2k
...
NOTE: Some moves in Master mode have a different command, as follows:

.Ryusokyaku: B, DB, D, DF, F, k
.Nidan Shoryuu Tsuki: B, DB, D, DF, F, 2k
.Metsu Shoryuu Ken: D, DF, F, D, DB, B, k
.Metsu Hadou Ken: F, DF, D, DB, B, 2
...
- In normal mode, you can cancel Nidan Shouryuu Tsuki to Shin Shoryuken, if you successfully hit your opponent
...
<Chars that have medium resistance to Shun Goku Satsu>
   - Blaze Agent, Dark Sakura, Funny Ryu, God Rugal and Oyaji
...
<??.09.2012>
- See Editor's Readme.txt for all changes and details
...
- Funny Ryu can now juggle after Shinkuu Hadouken in the corner, if you're quick enough
- Funny Ryu can no longer jump higher, made him too floaty
...
- Intro Ryu vs Funny Ryu, from SFZ3
...
- Ryu, Funny Ryu, Capcom Fighting Evolution, Capcom vs Snk and Street Fighter are property
of Capcom
